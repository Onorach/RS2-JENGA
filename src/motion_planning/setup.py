...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "test_mtc_pick_place = motion_planning.test_mtc_pick_place:main",
            "test_mtc_extract_side = motion_planning.test_mtc_extract_side:main",
            "test_mtc_extract_middle = motion_planning.test_mtc_extract_middle:main",
            "test_mtc_probe_block = motion_planning.test_mtc_probe_block:main",
